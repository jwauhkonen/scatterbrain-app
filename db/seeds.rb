...
song1 = Song.create(title: 'Wild Honey Pie', lyrics: 'Honey pie, honey pie, honey pie, honey pie, I love you!', 
artist_id: 0)

song2 = Song.create(title: 'Hey Ya', lyrics: "One, two, three!
...
Hey ya!(oh, oh) Hey ya!(oh, oh)
Hey ya!(oh, oh) Hey ya!(oh, oh)
Hey ya!(oh, oh) Hey ya!(oh, oh)", artist_id: 0)
